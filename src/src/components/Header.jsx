      ...
      <header className={colorHeaderClassname[seto.theme]}>
        <div className="header-menu">
          <div className="header-menu__container">
            <NavLink to="/" className={({ isActive }) => (isActive ? 'header-menu__icon icon-home-active icon-dark' : 'header-menu__icon icon-home icon-dark')}></NavLink>
            <NavLink to="/board" className={({ isActive }) => (isActive ? 'header-menu__icon icon-boards-active icon-dark' : 'header-menu__icon icon-boards icon-dark')}></NavLink>
            <NavLink to={accounts.isSignedIn ? `/member/${jwtDecode(accounts.userAccessToken).username}` : '/login'} className="header-menu__profile">
              <div
            ...
            <NavLink
              to="/challenge"
              className={({ isActive }) => (isActive ? 'header-menu__icon icon-ctf-active icon-dark' : 'header-menu__icon icon-ctf icon-dark')}
              // className="header-menu__icon icon-ctf icon-dark"
              // activeClassName="header-menu__icon icon-ctf-active icon-dark"
            ></NavLink>
            <NavLink
              to="/settings"
              className={({ isActive }) => (isActive ? 'header-menu__icon icon-settings-active icon-dark' : 'header-menu__icon icon-settings icon-dark')}
