          ...
          <div className="area">
            <section className="section-profile">
              <div
                ...
                style={{
                  backgroundImage: userInfo.profileUrl
                    ? `url(${forums.defaults.baseURL}/profiles/${userInfo.profileUrl})`
                    : `url(${process.env.PUBLIC_URL}/images/no-profile.svg)`,
                }}
              ></div>
              <div className="section-profile__textsContainer">
                <p className="section-profile__textsContainer-username">{userInfo.name ? userInfo.name : 'Name'}</p>
                ...
                <div className="section-profile__textsContainer__tools">
                  ...
                  <Link to="/editmember/root" className="section-profile__textsContainer__tools-button noselect">
                    내 정보 수정
                  </Link>
                </div>
              </div>
