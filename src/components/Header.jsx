...
const Header = (props) => {
        ...
        <div className="header-menu">
          <div className="header-menu__container">
            <NavLink
              to="/"
              className={({ isActive }) =>
                isActive ? 'header-menu__icon icon-home-active icon-dark' : 'header-menu__icon icon-home icon-dark'
              }
            ></NavLink>
            <NavLink
              to="/board"
              className={({ isActive }) =>
                isActive ? 'header-menu__icon icon-boards-active icon-dark' : 'header-menu__icon icon-boards icon-dark'
              }
            ></NavLink>
            <NavLink
              ...
              <div
                ...
                style={{
                  backgroundImage: localProfileImage
                    ? `url(${forums.defaults.baseURL}/profiles/${localProfileImage})`
            ...
            <NavLink
              to="/challenge"
              className={({ isActive }) =>
                isActive ? 'header-menu__icon icon-ctf-active icon-dark' : 'header-menu__icon icon-ctf icon-dark'
              }
            ...
            <NavLink
              to="/settings"
              className={({ isActive }) =>
                isActive ? 'header-menu__icon icon-settings-active icon-dark' : 'header-menu__icon icon-settings icon-dark'
              }
  ...
  useEffect(() => {
    ...
    if (accounts.isSignedIn) {
      forums.get('/members/info').then((res) => {
        // console.log(res.data.profileImage);
        setLocalProfileImage((state) => res.data.profileUrl);
      });
    }
  }, [accounts.isSignedIn]);
